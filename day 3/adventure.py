hook = "You are walking through the woods with the queen's " \
"precious cargo. You hear a loud thump in the trail in front of you. " \
"What do you do? A. Run and hide B. Turn around couragously C. Run " \
"towards the noise."

decision_a = "You hide behind a tree and fall into a reality warping " \
"hole. You land on Tatoonine. What do you do? D. Get on the pod racer " \
"E. Call for help F. Cry."

decision_b = "You face a giant snaggletoothed rat. It is hungry. " \
"What do you do? G. Fight the rat H. Run and hide I. Befriend the rat."

decision_c = "You find a kind old man who tripped. He offers " \
"you a wish. What do you do. J. Run and hide K. Ask about the " \
"conditions of the wish. L. Wish for BYU chocolate milk."

decision_d = "You are challenged to a race. What do you do? " \
"M. Win the race N. Lose the race."

decision_e = "Sand people come to eat you. What do you? O. " \
"Fight P. Run and hide"
